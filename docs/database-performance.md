...
- `documentos`: 28 linhas;
- `clientes`: 14 linhas;
- `visualizacoes_documentos`: 6 linhas.

A consulta representativa da listagem de documentos de um cliente, filtrando por
...
- a tabela alcançar aproximadamente 10 mil documentos;
