...
ALTER TABLE "folhas_pagamento" ADD COLUMN "arquivo_key" text;--> statement-breakpoint
ALTER TABLE "folhas_pagamento" ADD COLUMN "arquivo_nome" text;--> statement-breakpoint
